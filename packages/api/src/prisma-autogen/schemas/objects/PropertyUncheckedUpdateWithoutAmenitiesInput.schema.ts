...
const Schema: z.ZodType<Prisma.PropertyUncheckedUpdateWithoutAmenitiesInput> = z
  .object({
...
export const PropertyUncheckedUpdateWithoutAmenitiesInputObjectSchema = Schema
