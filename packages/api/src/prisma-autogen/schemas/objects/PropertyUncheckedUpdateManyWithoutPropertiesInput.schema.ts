...
const Schema: z.ZodType<Prisma.PropertyUncheckedUpdateManyWithoutPropertiesInput> = z
  .object({
...
export const PropertyUncheckedUpdateManyWithoutPropertiesInputObjectSchema = Schema
