...
const Schema: z.ZodType<Prisma.ListingUncheckedCreateNestedManyWithoutPropertyInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const ListingUncheckedCreateNestedManyWithoutPropertyInputObjectSchema = Schema
