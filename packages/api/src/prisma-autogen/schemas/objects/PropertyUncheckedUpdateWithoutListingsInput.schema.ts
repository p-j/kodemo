...
const Schema: z.ZodType<Prisma.PropertyUncheckedUpdateWithoutListingsInput> = z
  .object({
...
export const PropertyUncheckedUpdateWithoutListingsInputObjectSchema = Schema
