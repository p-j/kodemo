...
const Schema: z.ZodType<Prisma.PropertyUncheckedUpdateWithoutPicturesInput> = z
  .object({
...
export const PropertyUncheckedUpdateWithoutPicturesInputObjectSchema = Schema
