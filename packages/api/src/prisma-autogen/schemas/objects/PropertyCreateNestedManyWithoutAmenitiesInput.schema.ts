...
const Schema: z.ZodType<Prisma.PropertyCreateNestedManyWithoutAmenitiesInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PropertyCreateNestedManyWithoutAmenitiesInputObjectSchema = Schema
