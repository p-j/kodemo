...
const Schema: z.ZodType<Prisma.PropertyCreateNestedManyWithoutUserInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PropertyCreateNestedManyWithoutUserInputObjectSchema = Schema
