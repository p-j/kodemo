...
const Schema: z.ZodType<Prisma.ListingUncheckedUpdateManyWithoutPropertyNestedInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const ListingUncheckedUpdateManyWithoutPropertyNestedInputObjectSchema = Schema
