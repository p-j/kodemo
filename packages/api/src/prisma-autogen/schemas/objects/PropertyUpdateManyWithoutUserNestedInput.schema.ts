...
const Schema: z.ZodType<Prisma.PropertyUpdateManyWithoutUserNestedInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PropertyUpdateManyWithoutUserNestedInputObjectSchema = Schema
