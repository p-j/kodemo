...
const Schema: z.ZodType<Prisma.PictureWhereInput> = z
  .object({
    AND: z
      .union([z.lazy(() => PictureWhereInputObjectSchema), z.lazy(() => PictureWhereInputObjectSchema).array()])
      .optional(),
    OR: z
      .lazy(() => PictureWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([z.lazy(() => PictureWhereInputObjectSchema), z.lazy(() => PictureWhereInputObjectSchema).array()])
...
export const PictureWhereInputObjectSchema = Schema
