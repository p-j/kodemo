...
import { PropertyUpdateOneRequiredWithoutListingsNestedInputObjectSchema } from './PropertyUpdateOneRequiredWithoutListingsNestedInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.ListingUpdateInput> = z
  .object({
    ...
    property: z.lazy(() => PropertyUpdateOneRequiredWithoutListingsNestedInputObjectSchema).optional(),
  })
  .strict()

export const ListingUpdateInputObjectSchema = Schema
