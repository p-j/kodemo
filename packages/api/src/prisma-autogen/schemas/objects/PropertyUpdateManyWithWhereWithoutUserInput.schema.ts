...
const Schema: z.ZodType<Prisma.PropertyUpdateManyWithWhereWithoutUserInput> = z
  .object({
...
export const PropertyUpdateManyWithWhereWithoutUserInputObjectSchema = Schema
