...
const Schema: z.ZodType<Prisma.PropertyUncheckedCreateWithoutAmenitiesInput> = z
  .object({
...
export const PropertyUncheckedCreateWithoutAmenitiesInputObjectSchema = Schema
