...
const Schema: z.ZodType<Prisma.PropertyUncheckedCreateWithoutListingsInput> = z
  .object({
...
export const PropertyUncheckedCreateWithoutListingsInputObjectSchema = Schema
