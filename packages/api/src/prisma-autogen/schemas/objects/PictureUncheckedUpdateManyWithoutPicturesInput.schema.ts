...
const Schema: z.ZodType<Prisma.PictureUncheckedUpdateManyWithoutPicturesInput> = z
  .object({
...
export const PictureUncheckedUpdateManyWithoutPicturesInputObjectSchema = Schema
