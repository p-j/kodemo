...
const Schema: z.ZodType<Prisma.AmenityUpdateManyWithoutPropertiesNestedInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const AmenityUpdateManyWithoutPropertiesNestedInputObjectSchema = Schema
