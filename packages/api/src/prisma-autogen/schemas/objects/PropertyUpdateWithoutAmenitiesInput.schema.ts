...
import { ListingUpdateManyWithoutPropertyNestedInputObjectSchema } from './ListingUpdateManyWithoutPropertyNestedInput.schema'
...
const Schema: z.ZodType<Prisma.PropertyUpdateWithoutAmenitiesInput> = z
  .object({
    ...
    hasElevator: z
      ...
      .optional()
      .nullable(),
    listings: z.lazy(() => ListingUpdateManyWithoutPropertyNestedInputObjectSchema).optional(),
...
export const PropertyUpdateWithoutAmenitiesInputObjectSchema = Schema
