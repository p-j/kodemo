...
const Schema: z.ZodType<Prisma.PictureUncheckedCreateNestedManyWithoutUserInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PictureUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema
