...
const Schema: z.ZodType<Prisma.PropertyUncheckedCreateWithoutPicturesInput> = z
  .object({
...
export const PropertyUncheckedCreateWithoutPicturesInputObjectSchema = Schema
