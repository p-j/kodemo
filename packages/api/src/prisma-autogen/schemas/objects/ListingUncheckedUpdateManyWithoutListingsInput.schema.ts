...
const Schema: z.ZodType<Prisma.ListingUncheckedUpdateManyWithoutListingsInput> = z
  .object({
...
export const ListingUncheckedUpdateManyWithoutListingsInputObjectSchema = Schema
