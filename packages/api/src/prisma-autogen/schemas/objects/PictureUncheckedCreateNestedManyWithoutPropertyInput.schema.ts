...
const Schema: z.ZodType<Prisma.PictureUncheckedCreateNestedManyWithoutPropertyInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PictureUncheckedCreateNestedManyWithoutPropertyInputObjectSchema = Schema
