...
const Schema: z.ZodType<Prisma.PropertyUncheckedUpdateManyWithoutAmenitiesNestedInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PropertyUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema = Schema
