...
import { NestedEnumStateWithAggregatesFilterObjectSchema } from './NestedEnumStateWithAggregatesFilter.schema'
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema'
import { NestedEnumStateFilterObjectSchema } from './NestedEnumStateFilter.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.EnumStateWithAggregatesFilter> = z
  .object({
...
export const EnumStateWithAggregatesFilterObjectSchema = Schema
