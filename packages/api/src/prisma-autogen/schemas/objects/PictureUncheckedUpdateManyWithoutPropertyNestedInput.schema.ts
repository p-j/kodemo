...
const Schema: z.ZodType<Prisma.PictureUncheckedUpdateManyWithoutPropertyNestedInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const PictureUncheckedUpdateManyWithoutPropertyNestedInputObjectSchema = Schema
