...
const Schema: z.ZodType<Prisma.AmenityUncheckedCreateNestedManyWithoutPropertiesInput> = z.union([
  z
    .object({
      create: z
        .union([
...
export const AmenityUncheckedCreateNestedManyWithoutPropertiesInputObjectSchema = Schema
